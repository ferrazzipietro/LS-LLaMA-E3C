...
class UnmaskingMistralModel(MistralPreTrainedModel):
    """
    Transformer decoder consisting of *config.num_hidden_layers* layers. Each layer is a [`MistralaDecoderLayer`]
...
class UnmaskingMistralForSequenceClassification(MistralPreTrainedModel):
...
class UnmaskingMistralForTokenClassification(MistralPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
        self.model = UnmaskingMistralModel(config)
