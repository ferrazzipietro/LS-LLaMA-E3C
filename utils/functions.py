...
def generate_adapters_list(log_run_name: str, appendix:str, training_type:str='', dtype=torch.float16) -> 'list[str]':
    """
                    ...
                    for gradient_accumulation_steps in gradient_accumulation_steps_list:
                        for learning_rate in learning_rate_list:
                            ...
                            if training_type == 'NoLora':
                                ...
                                ADAPTERS_CHECKPOINT = f"ferrazzipietro/LS_{model_name}_adapters_{models_params.TRAIN_LAYER}_{nbits}_{r}_{lora_alpha}_{lora_dropout}_{gradient_accumulation_steps}_{learning_rate}_{appendix}{extra_str_cl}_bf"
                            else:
